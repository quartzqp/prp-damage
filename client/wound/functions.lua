...
function ProcessDamage(ped)
	-- if not IsEntityDead(ped) or not (onDrugs > 0) and not isHospitalized then
	...
	-- 							exports["prp-hud-v2"]:NotificationCustom(
	...
	-- 					exports["prp-hud-v2"]:NotificationCustom(Config.Strings.Blackout, 5000)
